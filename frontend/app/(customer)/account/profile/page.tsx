...
import { User, Shield, Mail, Key, Loader2, CheckCircle2, Camera, LogOut } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-fade-in-up pb-12">
        ...
        <div className="p-8 md:p-12 flex flex-col md:flex-row gap-8 items-start md:items-center">
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-[var(--color-ash)] font-medium uppercase tracking-widest">
              ...
              <span className="flex items-center gap-1.5"><Shield className="w-4 h-4" /> VIP Member</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-[var(--color-white)] border border-[var(--color-light-ash)]/60 rounded-2xl overflow-hidden shadow-sm">
          <form onSubmit={handleUpdateProfile} className="p-8 flex flex-col h-full">
            ...
            <div className="space-y-6 flex-1">
              ...
              <div>
                <label className="block text-[10px] font-bold tracking-[0.2em] text-[var(--color-ash)] uppercase mb-2">Membership Status</label>
      ...
      <div className="flex justify-center pt-8 pb-4">
        <button 
          onClick={logout}
          className="flex items-center gap-2 text-xs font-bold tracking-widest text-[var(--color-ash)] uppercase hover:text-[var(--color-black)] transition-colors px-6 py-3 border border-[var(--color-light-ash)] rounded-xl hover:border-[var(--color-black)] hover:bg-[var(--color-background-subtle)]"
        >
